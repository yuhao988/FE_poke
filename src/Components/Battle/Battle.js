      ...
      <div className="box-holder">
        <div className="info-box">
          ...
          <ul>
            ...
            <li>HP: {char1.HP}</li>
            <li>Attack:{dmg1} {isDouble1 ? `x2` : null}</li>
            ...
            <li>Hitrate: {(stat1[0]-stat2[1])>100 ? 100 : stat1[0]-stat2[1]}</li>
        ...
        <div className="info-box">
          ...
          <ul>
            ...
            <li>HP: {char2.HP}</li>
            <li>Attack:{dmg2} {isDouble2 ? `x2` : null}</li>
            ...
            <li>Hitrate: {stat2[0]-stat1[1]>100 ? 100 : stat2[0]-stat1[1]}</li>
